...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#2d2d2d" style="background-color: #2d2d2d;">
    <tbody><tr>
        <td align="center">

            <table class="full" align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
                <tbody><tr>
                    <td align="center" class="pad10" style="background-color: #1e1d85; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;" background="'https://builder.dynamicxx.comimages/charts1_t7.png'">
                        ...
                        <table width="400" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#ffffff" style="background-color: #ffffff; width: 400px; border-radius: 10px;">
                            <tbody><tr>
                                <td width="100%" align="center" class="pad20">
                                    ...
                                    <table width="320" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="width: 320px;">
                                        ...
                                        <tr>
                                            <td width="100%" style="color: #1e1d85; font-family: Helvetica, Arial, sans-serif, 'Varela Round'; font-weight: 400; vertical-align: top; font-size: 40px; text-align: center; line-height: 46px;" class="fullCenter varela">
                                                Bienvenue
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td valign="middle" align="center" width="100%" class="fullCenter img73" style="line-height: 1px;">
                                                <a href="#" style="text-decoration: none;">
                                                    <img src="https://crm.cpn-aide-aux-entreprises.com/public/img/logo-cpn.gif" width="73" alt="" border="0" class="hover">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="100%" style="color: #1e1d85; font-family: Helvetica, Arial, sans-serif, 'Varela Round'; font-weight: 400; vertical-align: top; font-size: 22px; text-align: center; line-height: 26px;" class="fullCenter varela">
                                                Partager votre experience &nbsp;<br class="erase"> donnez votre avis
                                        ...
                                        <tr>
                                            <td width="100%" height="4" bgcolor="red" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="100%" height="30" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td class="fullCenter" align="center">
                                                <table border="0" cellpadding="0" cellspacing="0" align="center" class="buttonScale">
                                                    <tbody><tr>
                                                        <td align="center" height="44" valign="middle" bgcolor="#8b13fa" style="border-radius: 50px; padding-left: 30px; padding-right: 30px; padding-bottom: 1px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Hind Vadodara'; color: #ffffff; font-size: 15px; line-height: 20px;
background: #1e1d85;" class="hindvadodara">
                                                            <a href="https://cpn.cpn-aide-aux-entreprises.com/avis" style="color: #ffffff; text-decoration: none;">Votre avis est précieux</a>
                                                        </td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="100%" style="color: #1e1d85; font-family: Helvetica, Arial, sans-serif, 'Varela Round'; font-weight: bold; vertical-align: top; font-size: 90%; text-align: center; line-height: 1px;" class="fullCenter varela">
                                                <br>	<a href="https://www.facebook.com/CPN.aideauxentreprises"><img src="https://img.icons8.com/fluency/35/000000/facebook-new.png"/></a>
                                                <a href="https://www.instagram.com/cpn_aideauxentreprises/?hl=fr">	<img src="https://img.icons8.com/fluency/35/000000/instagram-new.png"/></a>

                                                <a href="https://www.linkedin.com/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2F76078573%2Fadmin%2F">	<img src="https://img.icons8.com/fluency/35/000000/linkedin.png"/></a>
                                        ...
                                        <tr>
                                            <td width="100%" style="color: #1e1d85; font-family: Helvetica, Arial, sans-serif, 'Varela Round'; font-weight: bold; vertical-align: top; font-size: 90%; text-align: center; line-height: 1px;" class="fullCenter varela">
                                                ...
                                                <p> Financement-Innovation -Accompagnement</p>
                                                <br>
                                            </td>
                                        </tr>
                        ...
                        <table width="400" border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; width: 400px;" class="fullCenter">
                            ...
                            <tr>
                                <td width="100%" style="color: #ffffff; font-family: Helvetica, Arial, sans-serif, 'Varela Round'; font-weight: 400; vertical-align: top; font-size: 12px; text-align: center; line-height: 18px;" class="fullCenter varela">
                                    <a href="http://cpn-aide-aux-entreprises.com/home">©cpn-aide-aux-entreprises </a>
                                </td>
                            </tr>
                            <tr>
                                <td width="100%" height="10" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
