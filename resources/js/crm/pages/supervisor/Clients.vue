                                  ...
                                  <v-card>
                                    <v-card-text class="p-1">
                                      <v-row dense>
                                        ...
                                        <v-col cols="12" md="12">
                                          <v-row dense no-gutters align="center">
                                            <v-col cols="6" md="6">Budget :</v-col>
                                            <v-col cols="6" md="6"><el-input disabled v-model="leads.detailDialog.data.investment.budget" placeholder="Budget"></el-input></v-col>
                                          </v-row>
                                        </v-col>
                                        <v-col cols="12" md="12">
                                          <v-row dense no-gutters align="center">
                                            <v-col cols="6" md="6">Service :</v-col>
                                            <v-col cols="6" md="6"><el-input disabled v-model="leads.detailDialog.data.investment.service" placeholder="Service"></el-input></v-col>
                                          </v-row>
                                        </v-col>
                                      </v-row>
                                    </v-card-text>
  ...
  methods:{
    ...
    leadDetail(data){
      ...
      this.leads.detailDialog.data = {
        ...
        investment:{
              budget:data.investment.budget,
              service:data.investment.service,
            },
        meeting:{
          id: data.meeting.zid,
